...
plt.figure()
plt.subplot(2,1,1)
plt.plot(days,all_data_mean_pupil_stress,'r',label='Stress')
plt.plot(days,all_data_mean_pupil_reg_after,'k',label='Regular After')
plt.plot(days,all_data_mean_pupil_reg_before,'b',label='Regular Before')
plt.xlabel('Sessions')
...
plt.subplot(2,1,2)
plt.plot(days,all_data_mean_ibi_stress,'r',label='Stress')
plt.plot(days,all_data_mean_ibi_reg_after,'k',label='Regular After')
plt.plot(days,all_data_mean_ibi_reg_before,'b',label='Regular Before')
plt.xlabel('Sessions')
plt.ylabel('Diameter (AU)')
plt.title('Pupil Diameters')
plt.legend()
