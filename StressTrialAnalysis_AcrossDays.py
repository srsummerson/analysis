...
plt.figure()
plt.subplot(2,1,1)
plt.errorbar(days,all_data_mean_pupil_stress,yerr=all_data_std_pupil_stress,'r',label='Stress')
plt.errorbar(days,all_data_mean_pupil_reg_after,yerr=all_data_std_pupil_red_after,'k',label='Regular After')
plt.errorbar(days,all_data_mean_pupil_reg_before,yerr=all_data_std_pupil_red_before,'b',label='Regular Before')
plt.xlabel('Sessions')
...
plt.subplot(2,1,2)
plt.errorbar(days,all_data_mean_ibi_stress,yerr=all_data_std_ibi_stress,'r',label='Stress')
plt.errorbar(days,all_data_mean_ibi_reg_after,yerr=all_data_std_ibi_reg_after,'k',label='Regular After')
plt.errorbar(days,all_data_mean_ibi_reg_before,yerr=all_data_std_ibi_reg_before,'b',label='Regular Before')
plt.xlabel('Sessions')
plt.ylabel('IBI (s)')
