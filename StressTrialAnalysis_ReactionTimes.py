...
plt.figure()
plt.bar(bins_reg,hist_successful_reg,width=0.025,color='r',label='Regular')
plt.bar(bins_stress+0.25,hist_successful_stress,width=0.025,color='b',label='Stress')
