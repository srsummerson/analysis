...
hdf_filenames = ['mari20180805_05_te1054.hdf', 'mari20180805_08_te1057.hdf']
filename = ['Mario20180805','Mario20180805']
block_num = [1, 2]
...
for i, hdf in enumerate(hdf_filenames):
	...
	if i ==0:
		...
		tdt_ind_hold_center = get_state_TDT_LFPvalues(sb.ind_hold_center_states,syncHDF_file)
	else:
		...
		inds = get_state_TDT_LFPvalues(sb.ind_hold_center_states,syncHDF_file)
