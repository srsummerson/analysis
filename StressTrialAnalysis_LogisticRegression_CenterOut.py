...
for i, hdf in enumerate(hdf_location):
	...
	if i ==0:
		...
		tdt_ind_hold_center = sb.get_state_TDT_LFPvalues(sb.ind_hold_center_states,mat_filename)
	else:
		...
		inds = sb.get_state_TDT_LFPvalues(sb.ind_hold_center_states,mat_filename)
